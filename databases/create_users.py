...
# Config DB
# ======================================================
DBHOST = os.environ.get("NEON_DBHOST_DIRECT")
DBPORT = int(os.environ.get("NEON_DBPORT", 5432))
DBNAME = os.environ.get("NEON_DBNAME")
DBUSER = os.environ.get("NEON_DBUSER")
DBPASSWORD = os.environ.get("NEON_DBPASSWORD")

if not all([DBHOST, DBPORT, DBNAME, DBUSER, DBPASSWORD]):
    print("❌ Veuillez définir NEON_DBHOST_DIRECT, NEON_DBPORT, NEON_DBNAME, NEON_DBUSER, NEON_DBPASSWORD")
    sys.exit(1)
