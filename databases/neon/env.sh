...
DB_CONFIG_UPPER=$(echo "$DB_CONFIG" | tr '[:lower:]' '[:upper:]')

VAR_HOST="${DB_CONFIG_UPPER}_DBHOST"
VAR_HOST_DIRECT="${DB_CONFIG_UPPER}_DBHOST_DIRECT"
VAR_PASSWORD="${DB_CONFIG_UPPER}_DBPASSWORD"
