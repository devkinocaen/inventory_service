CREATE OR REPLACE FUNCTION inventory.create_booking(
    ...
    p_status                 inventory.booking_status DEFAULT 'à valider'
)
RETURNS TABLE (
    id                     INTEGER,
...
BEGIN
    -- Vérification des conflits seulement si le statut est 'validé'
    ...
    RETURNING
        ...
        end_date,
        status,
        tsrange(start_date, end_date)::text AS period;
